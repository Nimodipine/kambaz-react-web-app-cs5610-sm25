  ...
  return (
    <div>
      <ul>
        ...
        <li><Link to="/Labs/Lab3">Lab 4</Link></li>
        <li><Link to="/Labs/Lab3">Lab 5</Link></li>
      ...
      <Nav variant="pills" id="wd-toc">
        ...
        <Nav.Item> <Nav.Link as={Link} to="/Labs/Lab5" id="wd-a3"
          active={pathname.includes("Lab3")}> Lab 5 </Nav.Link> </Nav.Item>
        <Nav.Item> <Nav.Link as={Link} to="/Kambaz" id="wd-a3"> Kambaz </Nav.Link> </Nav.Item>
        <Nav.Item> <Nav.Link href="https://github.com/Nimodipine" target="_blank"> My GitHub </Nav.Link> </Nav.Item>
      </Nav>
